...
from server.helpers.tests.utils import CustomTestCase
from .test_serializers import UserRegistrationSerializerTest as Utest
...
class AccountTests(CustomTestCase, APITestCase):
    ...
    def test_account_register_successful(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION=get_basic_auth_header(
            'emailwilllogin@mydomain.com', 'test'))
    ...
    def test_account_confirm_email_unsuccessful(self):
        ...
        invalid_data = {'status': status.HTTP_404_NOT_FOUND,
                        'method': 'GET', 'data': {}, 'label': 'Not found'}
        self.assert_invalid_data_response(
    ...
    def test_account_confirm_email_successful(self):
        ...
        url = reverse('accounts:confirm_email', args=[
