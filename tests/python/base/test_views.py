...
from ..accounts.test_models import UserFactory
from ..accounts.test_views import get_basic_auth_header
...
class BaseTests(APITestCase):
    ...
    def test_get_protected_page(self):
        ...
        self.assertEqual(
            response.data['data'], 'THIS IS THE PROTECTED STRING FROM SERVER')
