...
class AdminSite(object):
    ...
    def disable_action(self, name):
        """
        Disable a globally-registered action.
    ...
    def each_context(self, request):
        ...
        *every* page in the admin site.
        ...
        site_url = script_name if self.site_url == '/' and \
            script_name else self.site_url
        return {
    ...
    def password_change(self, request, extra_context=None):
        ...
        defaults = {
            ...
            'success_url': url,
            'extra_context': dict(self.each_context(request),
                                  **(extra_context or {})),
        }
